...
public class fQ {
   ...
   public fQ(fJ var1, string var2, int var3, bool var4) {
      ...
      this.lO = var3;
      if (var4) {
         FileStream var5 = new FileStream(JavaFile.Create(fJ.a(var1), "mf_" + var2));
          int var7;
         try {
   ...
   public long lastModified() {
      return (JavaFile.Create(fJ.a(this.mt), "mf_" + this.filename)).LastWriteTimeUtc.Ticks;
   }
   ...
   public byte[] ah(int var1) {
      Object var2 = new FileStream(JavaFile.Create(fJ.a(this.mt), this.filename));
       try {
   ...
   public void a(string var1, fn var2, string var3, string var4) {
      FileInfo var5 = JavaFile.Create(fJ.a(this.mt), "mf_" + this.filename);
      FileInfo var6 = JavaFile.Create(fJ.a(this.mt), this.filename);
      ...
      FileInfo var9 = JavaFile.Create(aH.cG, var8);
   ...
   public void a(eY var1, bool var2) {
      ...
      int var36 = 0;
      Object var37 = new FileStream(JavaFile.Create(fJ.a(this.mt), this.filename));
       try {
         if (var2) {
      ...
      FileStream var38 = new FileStream(JavaFile.Create(fJ.a(this.mt), "mf_" + this.filename));
       try {
