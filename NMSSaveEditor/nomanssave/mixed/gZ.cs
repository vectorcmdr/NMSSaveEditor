...
public class gZ : FilterOutputStream {
   ...
   public void ek() {
      ...
      byte[] var4 = new byte[] {unchecked((byte)-27), unchecked((byte)-95), unchecked((byte)-19), unchecked((byte)-2), (byte)(255 & var3), (byte)(255 & var3 >> 8), (byte)(255 & var3 >> 16), (byte)(255 & var3 >> 24), (byte)(255 & this.sg), (byte)(255 & this.sg >> 8), (byte)(255 & this.sg >> 16), (byte)(255 & this.sg >> 24), 0, 0, 0, 0};
      this.@out.Write(var4);
