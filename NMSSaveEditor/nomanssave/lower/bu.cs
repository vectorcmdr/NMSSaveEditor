...
public class bu : Runnable {
   ...
   public void run() {
      ...
      if (bl.b(bt.a(this.es)) < 0) {
         ...
         for(var1 = 0; var1 < bl.d(bt.a(this.es)).Length; ++var1) {
            // PORT_TODO: bl.d(bt.a(this.es))[var1].Text = ((bl.c(bt.a(this.es).ToString())[bl.b(bt.a(this.es))].aq(var1)));
         }
         ...
         // PORT_TODO: bl.u(bt.a(this.es)).Text = ((bl.c(bt.a(this.es).ToString())[bl.b(bt.a(this.es))].dc()));
         // PORT_TODO: bl.v(bt.a(this.es)).Text = ((bl.c(bt.a(this.es).ToString())[bl.b(bt.a(this.es))].dd()));
         // PORT_TODO: bl.w(bt.a(this.es)).Text = ((bl.c(bt.a(this.es).ToString())[bl.b(bt.a(this.es))].de()));
         // PORT_TODO: bl.x(bt.a(this.es)).Text = ((bl.c(bt.a(this.es).ToString())[bl.b(bt.a(this.es))].df()));
