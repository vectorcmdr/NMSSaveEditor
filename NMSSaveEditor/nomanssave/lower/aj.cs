...
public class aj : Form {
   ...
   private aj(Frame var1) {
      ...
      var10.setLayout(new FlowLayoutPanel(1, 5, 5));
      ...
      var14.setLayout(new FlowLayoutPanel(2));
