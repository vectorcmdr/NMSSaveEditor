...
public class h : Form {
   ...
   private h(Frame var1) {
      ...
      var3.LayoutEnginenew FormLayout(new ColumnSpec[]{FormFactory.LABEL_COMPONENT_GAP_COLSPEC, ColumnSpec.decode("100px"), FormFactory.LABEL_COMPONENT_GAP_COLSPEC, ColumnSpec.decode("280px"), FormFactory.LABEL_COMPONENT_GAP_COLSPEC}, new RowSpec[]{FormFactory.LINE_GAP_ROWSPEC, FormFactory.DEFAULT_ROWSPEC, FormFactory.LINE_GAP_ROWSPEC, FormFactory.DEFAULT_ROWSPEC, FormFactory.LINE_GAP_ROWSPEC, FormFactory.DEFAULT_ROWSPEC, FormFactory.LINE_GAP_ROWSPEC, FormFactory.DEFAULT_ROWSPEC, FormFactory.LINE_GAP_ROWSPEC}));
      Label var4 = new Label("Search:");
      var3.Add(var4, "2, 2, left, center");
      Panel var5 = new Panel();
      var5.LayoutEnginenew TableLayoutPanel(0, 0));
      this.m = new TextBox();
      this.m.Text = ("");
      ...
      var9.LayoutEnginenew FlowLayoutPanel(2));
      var2.Add(var9, "South");
