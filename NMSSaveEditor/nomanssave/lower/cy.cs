      ...
      if (this.ge) {
         if (this.ga && this.fZ != null) {
            try {
               ...
               if (var2.Length == 0 && JOptionPane.showConfirmDialog(this, "The JSON data has been deleted, do you wish to apply these changes to the save file?", this.Text, 0) == 0) {
                  this.fZ.Remove();
                  ((cI)this.fV.GetModel()).a(this.fZ.gi);
               } else if (JOptionPane.showConfirmDialog(this, "The JSON data has changed, do you wish to apply these changes to the save file?", this.Text, 0) == 0) {
                  this.fZ.SetText(var2);
                  ((cI)this.fV.GetModel()).a(this.fZ);
               }
            } catch (eX var3) {
               JavaCompat.ShowOptionDialog(this, "Error on line #" + var3.getLineNumber() + ": " + var3.getMessage(), "Error", 0, 0, (Icon)null, new Object[]{"Cancel"}, (Object)null);
