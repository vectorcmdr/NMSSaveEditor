...
/*  24 */     SafeUtils.checkRange(src, srcOff);
/*  25 */     SafeUtils.checkRange(dest, destOff, destLen);
/*     */     
/*  27 */     if (destLen == 0) {
/*  28 */       if (SafeUtils.readByte(src, srcOff) != 0) {
...
/*     */     
/*     */     while (true) {
/*  41 */       int token = SafeUtils.readByte(src, sOff) & 0xFF;
/*  42 */       sOff++;
/*     */ 
/*     */       
...
/*  46 */       if (literalLen == 15) {
/*  47 */         byte len = -1;
/*  48 */         while ((len = SafeUtils.readByte(src, sOff++)) == -1) {
/*  49 */           literalLen += 255;
/*     */         }
...
/*     */         }
/*     */         
/*  61 */         LZ4SafeUtils.safeArraycopy(src, sOff, dest, dOff, literalLen);
/*  62 */         sOff += literalLen;
...
/*     */       } 
/*     */       
/*  68 */       LZ4SafeUtils.wildArraycopy(src, sOff, dest, dOff, literalLen);
/*  69 */       sOff += literalLen;
/*  70 */       dOff = literalCopyEnd;
/*     */ 
/*     */       
/*  73 */       int matchDec = SafeUtils.readShortLE(src, sOff);
/*  74 */       sOff += 2;
...
/*  82 */       if (matchLen == 15) {
/*  83 */         byte len = -1;
/*  84 */         while ((len = SafeUtils.readByte(src, sOff++)) == -1) {
/*  85 */           matchLen += 255;
/*     */         }
...
/*     */         }
/*  97 */         LZ4SafeUtils.safeIncrementalCopy(dest, matchOff, dOff, matchLen);
/*     */       } else {
/*  99 */         LZ4SafeUtils.wildIncrementalCopy(dest, matchOff, dOff, matchCopyEnd);
/*     */       } 
