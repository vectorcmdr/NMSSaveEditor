...
/*  21 */       return new StreamingXXHash64JavaSafe(seed);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*  60 */       long k1 = SafeUtils.readLongLE(this.memory, off);
...
/*  67 */       h64 ^= (SafeUtils.readIntLE(this.memory, off) & 0xFFFFFFFFL) * -7046029288634856825L;
...
/*     */       
/* 104 */       this.v1 += SafeUtils.readLongLE(this.memory, 0) * -4417276706812531889L;
/* 105 */       this.v1 = Long.rotateLeft(this.v1, 31);
/* 106 */       this.v1 *= -7046029288634856825L;
/*     */       
/* 108 */       this.v2 += SafeUtils.readLongLE(this.memory, 8) * -4417276706812531889L;
/* 109 */       this.v2 = Long.rotateLeft(this.v2, 31);
/* 110 */       this.v2 *= -7046029288634856825L;
/*     */       
/* 112 */       this.v3 += SafeUtils.readLongLE(this.memory, 16) * -4417276706812531889L;
/* 113 */       this.v3 = Long.rotateLeft(this.v3, 31);
/* 114 */       this.v3 *= -7046029288634856825L;
/*     */       
/* 116 */       this.v4 += SafeUtils.readLongLE(this.memory, 24) * -4417276706812531889L;
...
/*     */     
/* 131 */     while (off <= limit) {
/* 132 */       v1 += SafeUtils.readLongLE(buf, off) * -4417276706812531889L;
/* 133 */       v1 = Long.rotateLeft(v1, 31);
/* 134 */       v1 *= -7046029288634856825L;
/* 135 */       off += 8;
/*     */       
/* 137 */       v2 += SafeUtils.readLongLE(buf, off) * -4417276706812531889L;
/* 138 */       v2 = Long.rotateLeft(v2, 31);
/* 139 */       v2 *= -7046029288634856825L;
/* 140 */       off += 8;
/*     */       
/* 142 */       v3 += SafeUtils.readLongLE(buf, off) * -4417276706812531889L;
/* 143 */       v3 = Long.rotateLeft(v3, 31);
/* 144 */       v3 *= -7046029288634856825L;
/* 145 */       off += 8;
/*     */       
/* 147 */       v4 += SafeUtils.readLongLE(buf, off) * -4417276706812531889L;
...
/* Location:              E:\NMSSE_Source\NMSSaveEditor.jar!\net\jpountz\xxhash\StreamingXXHash64JavaSafe.class
