...
/*     */       do {
/*  36 */         v1 += SafeUtils.readIntLE(buf, off) * -2048144777;
/*  37 */         v1 = Integer.rotateLeft(v1, 13);
/*  38 */         v1 *= -1640531535;
/*  39 */         off += 4;
/*     */         
/*  41 */         v2 += SafeUtils.readIntLE(buf, off) * -2048144777;
/*  42 */         v2 = Integer.rotateLeft(v2, 13);
/*  43 */         v2 *= -1640531535;
/*  44 */         off += 4;
/*     */         
/*  46 */         v3 += SafeUtils.readIntLE(buf, off) * -2048144777;
/*  47 */         v3 = Integer.rotateLeft(v3, 13);
/*  48 */         v3 *= -1640531535;
/*  49 */         off += 4;
/*     */         
/*  51 */         v4 += SafeUtils.readIntLE(buf, off) * -2048144777;
...
/*     */     
/*  64 */     while (off <= end - 4) {
/*  65 */       h32 += SafeUtils.readIntLE(buf, off) * -1028477379;
/*  66 */       h32 = Integer.rotateLeft(h32, 17) * 668265263;
/*  67 */       off += 4;
/*     */     } 
/*     */     
/*  70 */     while (off < end) {
/*  71 */       h32 += (SafeUtils.readByte(buf, off) & 0xFF) * 374761393;
...
/* Location:              E:\NMSSE_Source\NMSSaveEditor.jar!\net\jpountz\xxhash\XXHash32JavaSafe.class
