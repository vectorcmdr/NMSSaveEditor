...
/*  21 */       return new StreamingXXHash32JavaUnsafe(seed);
/*     */     }
/*     */   }
/*     */ 
/*     */   
...
/*  43 */       h32 += UnsafeUtils.readIntLE(this.memory, off) * -1028477379;
/*  44 */       h32 = Integer.rotateLeft(h32, 17) * 668265263;
/*  45 */       off += 4;
/*     */     } 
/*     */     
/*  48 */     while (off < this.memSize) {
/*  49 */       h32 += (UnsafeUtils.readByte(this.memory, off) & 0xFF) * 374761393;
...
/*     */       
/*  80 */       this.v1 += UnsafeUtils.readIntLE(this.memory, 0) * -2048144777;
/*  81 */       this.v1 = Integer.rotateLeft(this.v1, 13);
/*  82 */       this.v1 *= -1640531535;
/*     */       
/*  84 */       this.v2 += UnsafeUtils.readIntLE(this.memory, 4) * -2048144777;
/*  85 */       this.v2 = Integer.rotateLeft(this.v2, 13);
/*  86 */       this.v2 *= -1640531535;
/*     */       
/*  88 */       this.v3 += UnsafeUtils.readIntLE(this.memory, 8) * -2048144777;
/*  89 */       this.v3 = Integer.rotateLeft(this.v3, 13);
/*  90 */       this.v3 *= -1640531535;
/*     */       
/*  92 */       this.v4 += UnsafeUtils.readIntLE(this.memory, 12) * -2048144777;
...
/*     */     
/* 107 */     while (off <= limit) {
/* 108 */       v1 += UnsafeUtils.readIntLE(buf, off) * -2048144777;
/* 109 */       v1 = Integer.rotateLeft(v1, 13);
/* 110 */       v1 *= -1640531535;
/* 111 */       off += 4;
/*     */       
/* 113 */       v2 += UnsafeUtils.readIntLE(buf, off) * -2048144777;
/* 114 */       v2 = Integer.rotateLeft(v2, 13);
/* 115 */       v2 *= -1640531535;
/* 116 */       off += 4;
/*     */       
/* 118 */       v3 += UnsafeUtils.readIntLE(buf, off) * -2048144777;
/* 119 */       v3 = Integer.rotateLeft(v3, 13);
/* 120 */       v3 *= -1640531535;
/* 121 */       off += 4;
/*     */       
/* 123 */       v4 += UnsafeUtils.readIntLE(buf, off) * -2048144777;
...
/* Location:              E:\NMSSE_Source\NMSSaveEditor.jar!\net\jpountz\xxhash\StreamingXXHash32JavaUnsafe.class
