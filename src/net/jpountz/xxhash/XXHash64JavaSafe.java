...
/*     */     long h64;
/*  24 */     SafeUtils.checkRange(buf, off, len);
/*     */     
/*  26 */     int end = off + len;
/*     */ 
/*     */     
...
/*     */       do {
/*  36 */         v1 += SafeUtils.readLongLE(buf, off) * -4417276706812531889L;
/*  37 */         v1 = Long.rotateLeft(v1, 31);
/*  38 */         v1 *= -7046029288634856825L;
/*  39 */         off += 8;
/*     */         
/*  41 */         v2 += SafeUtils.readLongLE(buf, off) * -4417276706812531889L;
/*  42 */         v2 = Long.rotateLeft(v2, 31);
/*  43 */         v2 *= -7046029288634856825L;
/*  44 */         off += 8;
/*     */         
/*  46 */         v3 += SafeUtils.readLongLE(buf, off) * -4417276706812531889L;
/*  47 */         v3 = Long.rotateLeft(v3, 31);
/*  48 */         v3 *= -7046029288634856825L;
/*  49 */         off += 8;
/*     */         
/*  51 */         v4 += SafeUtils.readLongLE(buf, off) * -4417276706812531889L;
...
/*     */     
/*  76 */     while (off <= end - 8) {
/*  77 */       long k1 = SafeUtils.readLongLE(buf, off);
...
/*     */     
/*  83 */     if (off <= end - 4) {
/*  84 */       h64 ^= (SafeUtils.readIntLE(buf, off) & 0xFFFFFFFFL) * -7046029288634856825L;
/*  85 */       h64 = Long.rotateLeft(h64, 23) * -4417276706812531889L + 1609587929392839161L;
/*  86 */       off += 4;
/*     */     } 
/*     */     
/*  89 */     while (off < end) {
/*  90 */       h64 ^= (SafeUtils.readByte(buf, off) & 0xFF) * 2870177450012600261L;
