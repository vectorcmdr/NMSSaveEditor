...
public class SystemInfo {
   ...
   static {
      ...
      isMacFullWindowContentSupported = isMacOS && (javaVersion >= toVersion(11, 0, 8, 0) || javaVersion >= toVersion(1, 8, 0, 292) && !isJava_9_orLater);
      boolean isWin_11_orLater = false;

      try {
         isWin_11_orLater = isWindows_10_orLater && (scanVersion(StringUtils.removeLeading(osName, "windows ")) >= toVersion(11, 0, 0, 0) || FlatNativeWindowsLibrary.isLoaded() && FlatNativeWindowsLibrary.getOSBuildNumber() >= 22000L);
