...
/* 1157 */     return Objects.equals(c.getClientProperty(key), value);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1165 */     Object value = c.getClientProperty(key);
/* 1166 */     return (value instanceof Boolean) ? ((Boolean)value).booleanValue() : defaultValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1174 */     return clientProperty(c, key, defaultValue, Boolean.class);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1182 */     Object value = c.getClientProperty(key);
/* 1183 */     return (value instanceof Integer) ? ((Integer)value).intValue() : defaultValue;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1191 */     return clientProperty(c, key, defaultValue, Color.class);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* 1202 */     Object value = c.getClientProperty(key);
/* 1203 */     return type.isInstance(value) ? (T)value : defaultValue;
/*      */   }
/*      */ }


/* Location:              E:\NMSSE_Source\NMSSaveEditor.jar!\com\formdev\flatlaf\FlatClientProperties.class
