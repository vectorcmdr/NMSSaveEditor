...
public class ho extends FilterOutputStream {
  ...
  public ho(OutputStream paramOutputStream) {
  ...
  private void ek() {
    ...
    arrayOfByte2[0] = (byte)(0xFF & this.sd);
    arrayOfByte2[1] = (byte)(0xFF & this.sd >> 8);
    arrayOfByte2[2] = (byte)(0xFF & this.sd >> 16);
    arrayOfByte2[3] = (byte)(0xFF & this.sd >> 24);
