...
public class a extends JDialog {
   ...
   private a(Frame var1) {
      ...
      try {
         ...
         var3.insertString(var3.getLength(), "Version: 1.19.3", var5);
         ...
         var2.setText("No Man's Sky Save EditorVersion: 1.19.3by GoatFungusFor further information visit:https://github.com/goatfungus/NMSSaveEditor");
      }
